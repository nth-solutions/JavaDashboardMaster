...
/************************************************create axis data series for all axes********************************************************************************************/
		...
		for (int i = 0; i < 3; i++) {
			...
			// acceleration
			axes[i] = new AxisDataSeries(timeAxis, d.getDataSamples().get(i), AxisType.valueOf(i), d.getMPUOffsets(), d.accelSensitivity, d.getSampleRate());
			...
			axes[i+16] = new AxisDataSeries(timeAxis, d.getDataSamples().get(i+3), AxisType.valueOf(i+16), d.gyroSensitivity, d.getSampleRate());
		...
		/************************************************magnitude series********************************************************************************************/		
		//accel magnitude
		axes[3] = new AxisDataSeries(timeAxis, d.getDataSamples().get(0), AxisType.valueOf(3), d.getMPUOffsets(), d.accelSensitivity, d.getSampleRate()); 
		// velocity magnitude
		axes[7] = new AxisDataSeries(timeAxis, d.getDataSamples().get(0), AxisType.valueOf(7), d.getMPUOffsets(), d.accelSensitivity, d.getSampleRate());
		//displacement magnitude
		axes[11] = new AxisDataSeries(timeAxis, d.getDataSamples().get(0), AxisType.valueOf(11), d.getMPUOffsets(), d.accelSensitivity, d.getSampleRate());
		// Angular accel magnitude
		axes[15] = new AxisDataSeries(timeAxis, d.getDataSamples().get(3), AxisType.valueOf(15), d.gyroSensitivity, d.getSampleRate());
		//(GYRO) Angular velocity magnitude
		axes[19] = new AxisDataSeries(timeAxis, d.getDataSamples().get(3), AxisType.valueOf(19), d.gyroSensitivity, d.getSampleRate());
		// Angular displacement magnitude
		axes[23] = new AxisDataSeries(timeAxis, d.getDataSamples().get(3), AxisType.valueOf(23), d.gyroSensitivity, d.getSampleRate());
